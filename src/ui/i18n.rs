...
const ZH: Strings = Strings {
    ...
    no_data: "暂无数据",
    loading: "加载中…",
    key_invalid: "API key 无效，请在设置中检查",
    ...
    notify_threshold_desc: "超过阈值时提醒一次，重置后重新计数",
    notify_reset_5h_opt: "5 小时额度重置提醒",
    notify_reset_5h_desc: "5 小时窗口重置时通知",
    notify_reset_weekly_opt: "周额度重置提醒",
    notify_reset_weekly_desc: "周额度重置时通知",
    autostart: "开机自启",
    accounts_section: "账号",
    platform_section: "平台",
    add_account: "添加账号",
...
const EN: Strings = Strings {
    ...
    no_data: "No data yet",
    loading: "Loading…",
    key_invalid: "Invalid API key. Check it in Settings",
